...
namespace MarketPlace.Platforms.Android
{
    ...
    public class NotificationManagerService : INotificationManagerService
    {
        ...
        public async Task Show(string title, string message)
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(Platform.AppContext, channelId)
                ...
                .SetLargeIcon(BitmapFactory.DecodeResource(Platform.AppContext.Resources, Resource.Mipmap.app_green_market_round))
                .SetSmallIcon(Resource.Mipmap.app_green_market_round);
